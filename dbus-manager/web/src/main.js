...
import AddRule from './components/data-table/add-rule'
...
import AddTopology from './components/topology/topology-add'
...
ReactDOM.render(
  <Router history={hashHistory}>
    ...
    <Route path='/config' component={Config} />
      ...
      <Route path='/topology-add' component={AddTopology} />
