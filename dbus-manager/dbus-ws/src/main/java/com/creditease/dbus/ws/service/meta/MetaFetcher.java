...
package com.creditease.dbus.ws.service.meta;
...
public abstract class MetaFetcher {
    ...
    public MetaFetcher(DbusDataSource ds) {
        this.ds = ds;
    }
    ...
    public static MetaFetcher getFetcher(DbusDataSource ds) throws Exception {
        MetaFetcher fetcher;
