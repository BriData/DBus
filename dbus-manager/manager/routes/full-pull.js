...
//---------------以下为【可不提供】非关键字段------ 
    ...
    var typeList = [
        {
            type: "FULL_DATA_PULL_REQ",
            text: "独立全量拉取请求",
            template: buildTemplate('FULL_DATA_PULL_REQ',payload)
        }
    ];
...
router.post('/send', function (req, res) {
    ...
    var ctrlTopic = req.body.ctrlTopic;
    var outputTopic = req.body.outputTopic;
    fpService.send(ctrlTopic,outputTopic,message, function (e, response) {
