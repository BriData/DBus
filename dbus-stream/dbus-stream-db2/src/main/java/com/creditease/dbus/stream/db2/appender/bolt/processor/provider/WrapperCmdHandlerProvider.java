...
import com.creditease.dbus.stream.db2.appender.bolt.processor.wrapper.Db2WrapperDefaultHandler;
...
public class WrapperCmdHandlerProvider extends AbsCommandHandlerProvider {
    ...
    public BoltCommandHandler provideDefaultHandler(DbusDatasourceType type) {
        BoltCommandHandler defaultHandler = new Db2WrapperDefaultHandler(listener);
