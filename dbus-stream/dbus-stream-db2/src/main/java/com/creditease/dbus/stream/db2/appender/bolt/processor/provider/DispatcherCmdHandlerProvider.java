...
package com.creditease.dbus.stream.db2.appender.bolt.processor.provider;
...
import com.creditease.dbus.stream.db2.appender.bolt.processor.dispatcher.DispatcherDefaultHandler;
...
public class DispatcherCmdHandlerProvider extends AbsCommandHandlerProvider {
    ...
    public BoltCommandHandler provideDefaultHandler(DbusDatasourceType type) {
        BoltCommandHandler defaultHandler = new DispatcherDefaultHandler(listener);
