...
public class Db2WrapperData {
    private PairWrapper<String, Object> dataWrapper;
    private PairWrapper<String, Object> beforeDataWrapper;

    public Db2WrapperData() {
    }

    public Db2WrapperData(PairWrapper<String, Object> dataWrapper, PairWrapper<String, Object> beforeDataWrapper) {
