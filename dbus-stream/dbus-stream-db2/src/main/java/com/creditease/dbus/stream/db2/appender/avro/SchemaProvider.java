...
public class SchemaProvider {
    ...
    public static SchemaProvider getInstance() throws Exception {
    ...
    //从schema registry中获取schema信息
    public Schema getSchemaBySchemaRegistry(String schemaName, byte[] payload) throws Exception {
        Schema schema = schemaCache.get(schemaName);
        if (schema != null) {
            return schema;
        }
            ...
            try {
                ...
                try {
                    if (schemaStr == null) {
                        ...
                        if (Constants.DB2_GENERIC_SCHEMA.equals(schemaName)) {
