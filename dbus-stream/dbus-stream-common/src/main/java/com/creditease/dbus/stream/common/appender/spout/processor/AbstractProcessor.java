 ...
 */
public abstract class AbstractProcessor implements RecordProcessor<String, byte[]> {
    protected Logger logger = LoggerFactory.getLogger(getClass());

    protected RecordProcessListener listener;
    protected ConsumerListener consumerListener;

    public AbstractProcessor(RecordProcessListener listener, ConsumerListener consumerListener) {
