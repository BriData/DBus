...
import com.creditease.dbus.stream.mongo.appender.bolt.processor.wrapper.MongoWrapperDefaultHandler;
...
public class WrapperCmdHandlerProvider extends AbsCommandHandlerProvider {
    ...
    public BoltCommandHandler provideDefaultHandler(DbusDatasourceType type) {
        BoltCommandHandler defaultHandler = new MongoWrapperDefaultHandler(listener);
