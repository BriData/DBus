...
import com.creditease.dbus.stream.mysql.appender.bolt.processor.appender.MaDefaultHandler;
import com.creditease.dbus.stream.mysql.appender.bolt.processor.appender.MaMetaSyncEventHandler;
...
public class AppenderCmdHandlerProvider extends AbsCommandHandlerProvider {
    ...
    public BoltCommandHandler provideDefaultHandler(DbusDatasourceType type) {
        BoltCommandHandler defaultHandler = new MaDefaultHandler(listener);
