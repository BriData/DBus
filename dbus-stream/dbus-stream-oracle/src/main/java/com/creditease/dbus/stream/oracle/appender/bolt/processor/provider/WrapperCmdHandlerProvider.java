...
import com.creditease.dbus.stream.oracle.appender.bolt.processor.wrapper.OraWrapperDefaultHandler;
...
public class WrapperCmdHandlerProvider extends AbsCommandHandlerProvider {
    ...
    public BoltCommandHandler provideDefaultHandler(DbusDatasourceType type) {
        BoltCommandHandler defaultHandler = new OraWrapperDefaultHandler(listener);
