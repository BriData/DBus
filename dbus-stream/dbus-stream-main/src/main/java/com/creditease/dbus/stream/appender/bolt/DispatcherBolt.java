...
import static com.creditease.dbus.stream.common.Constants.EmitFields;
import static com.creditease.dbus.stream.common.Constants.StormConfigKey;
 ...
 */
public class DispatcherBolt extends BaseRichBolt implements CommandHandlerListener {
    ...
    private BoltCommandHandlerProvider buildProvider() throws Exception {
        /*Set<Class<?>> classes = AnnotationScanner.scan("com.creditease.dbus", BoltCmdHandlerProvider.class, (clazz, annotation) -> {
            ...
            return ca.type() == BoltType.DISPATCHER_BOLT;
        });
