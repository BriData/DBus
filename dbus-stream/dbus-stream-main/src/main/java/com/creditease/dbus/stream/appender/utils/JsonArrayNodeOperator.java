...
/**
 * Created by Shrimp on 16/7/8.
 */
public class JsonArrayNodeOperator extends ZKNodeOperator {
    ...
    public static void main(String[] args) {
        List<Map<String, Object>> list = (List<Map<String, Object>>) JSON.parse("[{\"cedb.TEST6\":\"end\"}]".getBytes());
