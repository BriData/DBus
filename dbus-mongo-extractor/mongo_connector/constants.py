...
# DBUS relative constants
DEFAULT_ZK_DBUS_EXTRACTOR_ROOT = "/DBus/Extractor"
DEFAULT_ZK_DBUSMGR_PATH = "/DBus/Commons/mysql.properties"
DEFAULT_ZK_MONGO_EXTRACTOR_PREFIX = "-mongo-extractor"
