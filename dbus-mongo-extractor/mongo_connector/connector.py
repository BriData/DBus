...
def get_config_options():
    ...
    def apply_doc_managers(option, cli_values):
        ...
        for dm in option.value:
            ...
            tid = dm['tid']
            if target_url:
                dm_instances.append(DocManager(target_url, tid, **kwargs))
            else:
...
def log_startup_info():
    ...
    LOG.critical('test log Platform: %s', platform.platform())
    LOG.error('test log Platform: %s', platform.platform())
    LOG.warning('test log Platform: %s', platform.platform())
