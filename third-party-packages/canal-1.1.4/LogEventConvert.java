                    ...
                    case Types.LONGVARBINARY:
                        ...
                        if (fieldMeta != null && isText(fieldMeta.getColumnType())) {
                            if (isShortText(fieldMeta.getColumnType())) {
                                ...
                                columnBuilder.setValue(new String("".getBytes(), this.charset));
                            }
                            javaType = Types.CLOB;
                            break;
                        }
                        ...
                        if (isLargeBlob(fieldMeta.getColumnType())) {
                            columnBuilder.setValue(new String("".getBytes(), "ISO-8859-1"));
                        } else {
                            columnBuilder.setValue(new String((byte[]) value, "ISO-8859-1"));
                        }
                        javaType = Types.BLOB;
                        break;
                    case Types.CHAR:
