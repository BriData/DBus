...
public abstract class DbConfigResource<T> extends AbstractConfigResource<T> {

    protected ILoadDbusConfigDao dbusDao;

    protected DbConfigResource(String name) {
        super(name);
    }

    protected void init() {
        dbusDao = new LoadDbusConfigDaoImpl();
    }
