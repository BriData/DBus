...
public class Reload extends HeartBeat {
    ...
    protected void register() {
        ...
        // 注册重新加载配置handler
        registerHandler(new ReloadHeartBeatHandler());
    }
