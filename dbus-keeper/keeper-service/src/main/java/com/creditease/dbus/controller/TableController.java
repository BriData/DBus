...
public class TableController extends BaseController {
    ...
    /**
     * 新增table/schema时，在源端表插入相关信息
     * @return
     */
    @PostMapping("/source-tables")
    public ResultEntity insertSourceTables(@RequestBody SourceTablesBean sourceTables){//@RequestParam int dsId,@RequestParam String sourceTables){
        ResultEntity resultEntity = tableService.insertTableInSource(sourceTables);
