...
public interface ProjectTopologyMapper {
    ...
    int insert(ProjectTopology record);

    ProjectTopology selectByPrimaryKey(Integer id);

    List<ProjectTopology> selectAll();

    int updateByPrimaryKey(ProjectTopology record);

    int selectCountByTopoName(String topoName);
