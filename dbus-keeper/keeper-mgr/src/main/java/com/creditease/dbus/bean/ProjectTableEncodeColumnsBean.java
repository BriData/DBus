 ...
 * Time: 下午4:40
 */
public class ProjectTableEncodeColumnsBean {
    private List<ProjectTableEncodeColumns> encodeOutputColumns;
    private int outputListType;

    public List<ProjectTableEncodeColumns> getEncodeOutputColumns() {
        return encodeOutputColumns;
    }

    public void setEncodeOutputColumns(List<ProjectTableEncodeColumns> encodeOutputColumns) {
