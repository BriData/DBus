...
public class SinkerTopologySchema {
    private Integer id;
    ...
    public Boolean getAddAllTable() {
        return addAllTable;
    }

    public void setAddAllTable(Boolean addAllTable) {
        this.addAllTable = addAllTable;
    }
}
