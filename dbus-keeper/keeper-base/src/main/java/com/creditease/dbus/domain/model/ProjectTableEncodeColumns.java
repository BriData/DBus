...
public class ProjectTableEncodeColumns {
    private Integer id;

    private Integer topoTableId;
    ...
    public Integer getTopoTableId() {
        return topoTableId;
    }

    public void setTopoTableId(Integer topoTableId) {
        this.topoTableId = topoTableId;
    }
    ...
    public String toString() {
        return "ProjectTableEncodeColumns{" +
                "id=" + id +
                ", topoTableId=" + topoTableId +
                ", fieldName='" + fieldName + '\'' +
