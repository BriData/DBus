...
export default class FileTree extends Component {
  ...
  render () {
    ...
    const { value, loadLevelOfPath, onReadData, onClone, onNext} = this.props
    return (
      <div>
        <TreeList
          ...
          value={value}
        />
        <Button style={{marginTop:10}} onClick={onClone}>克隆</Button>
        <Button style={{marginTop:10, marginLeft: 10}} type="primary" onClick={onNext}>下一步</Button>
        <Modal
